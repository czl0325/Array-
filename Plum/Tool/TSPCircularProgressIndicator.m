...
- (void)drawRect:(NSRect)dirtyRect {
	...
	if (showText) {
		...
		NSDictionary *attributesInProgress = [NSDictionary dictionaryWithObjectsAndKeys:[NSColor orangeColor], NSForegroundColorAttributeName,fontInProgress, NSFontAttributeName,nil];
